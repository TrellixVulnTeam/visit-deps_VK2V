...
foreach(_expectedTarget VTK::WrappingTools VTK::WrapHierarchy VTK::WrapPython VTK::WrapPythonInit VTK::ParseJava VTK::WrapJava VTK::loguru VTK::kwiml VTK::vtksys VTK::utf8 VTK::CommonCore VTK::CommonMath VTK::CommonTransforms VTK::CommonMisc VTK::CommonSystem VTK::CommonDataModel VTK::CommonExecutionModel VTK::ImagingCore VTK::ImagingMath VTK::FiltersCore VTK::CommonColor VTK::CommonComputationalGeometry VTK::FiltersGeneral VTK::FiltersGeometry VTK::FiltersSources VTK::RenderingCore VTK::RenderingUI VTK::opengl VTK::glew VTK::vtkTestOpenGLVersion VTK::RenderingOpenGL2 VTK::vtkProbeOpenGLVersion VTK::RenderingVolume VTK::RenderingVolumeOpenGL2 VTK::Python VTK::PythonUsed VTK::PythonInterpreter VTK::doubleconversion VTK::lz4 VTK::lzma VTK::zlib VTK::IOCore VTK::IOPLY VTK::libxml2 VTK::IOLegacy VTK::ImagingSources VTK::FiltersHybrid VTK::DICOMParser VTK::jpeg VTK::metaio VTK::png VTK::pugixml VTK::tiff VTK::IOImage VTK::jsoncpp VTK::IOGeometry VTK::IOEnSight VTK::FiltersModeling VTK::ImagingColor VTK::ImagingGeneral VTK::ImagingHybrid VTK::ImagingFourier VTK::eigen VTK::FiltersStatistics VTK::ParallelCore VTK::diy2 VTK::expat VTK::IOXMLParser VTK::IOXML VTK::ParallelDIY VTK::FiltersExtraction VTK::InteractionStyle VTK::freetype VTK::RenderingFreeType VTK::RenderingAnnotation VTK::InteractionWidgets VTK::GUISupportQt VTK::GUISupportQtOpenGL VTK::InfovisCore VTK::ViewsCore VTK::libproj VTK::InfovisLayout VTK::GeovisCore VTK::WrappingPythonCore VTK::FiltersFlowPaths)
...
# Create imported target VTK::GUISupportQtOpenGL
add_library(VTK::GUISupportQtOpenGL SHARED IMPORTED)

set_target_properties(VTK::GUISupportQtOpenGL PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/vtk-9.0"
  INTERFACE_LINK_LIBRARIES "VTK::CommonCore;VTK::RenderingOpenGL2;VTK::GUISupportQt;Qt5::OpenGL"
)
