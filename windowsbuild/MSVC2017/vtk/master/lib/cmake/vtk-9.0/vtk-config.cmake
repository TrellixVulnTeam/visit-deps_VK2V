...
set("${CMAKE_FIND_PACKAGE_NAME}_VERSION" "9.0.20210408")
set("${CMAKE_FIND_PACKAGE_NAME}_MAJOR_VERSION" "9")
set("${CMAKE_FIND_PACKAGE_NAME}_MINOR_VERSION" "0")
set("${CMAKE_FIND_PACKAGE_NAME}_BUILD_VERSION" "20210408")
set("${CMAKE_FIND_PACKAGE_NAME}_LEGACY_REMOVE" "ON")
set("${CMAKE_FIND_PACKAGE_NAME}_AUTOINIT_INCLUDE" "\"vtkAutoInit.h\"")

set("${CMAKE_FIND_PACKAGE_NAME}_AVAILABLE_COMPONENTS" "WrappingTools;loguru;RenderingVolumeOpenGL2;ImagingCore;ImagingMath;RenderingCore;RenderingVolume;CommonMath;CommonSystem;CommonTransforms;FiltersCore;FiltersGeneral;FiltersSources;glew;opengl;vtksys;PythonInterpreter;Python;CommonMisc;IOPLY;IOCore;libxml2;zlib;IOGeometry;CommonExecutionModel;IOImage;jsoncpp;IOEnSight;GUISupportQt;InteractionWidgets;FiltersExtraction;GeovisCore;InfovisCore;ViewsCore;libproj;ImagingSources;InfovisLayout;CommonComputationalGeometry;ImagingHybrid;RenderingUI;FiltersTexture;ImagingColor;ImagingGeneral;RenderingAnnotation;InteractionStyle;FiltersFlowPaths;FiltersGeometry;eigen;FiltersModeling;FiltersHybrid;RenderingOpenGL2;WrappingPythonCore;CommonColor;FiltersStatistics;ParallelDIY;ParallelCore;diy2;IOXML;IOXMLParser;expat;IOLegacy;doubleconversion;lz4;lzma;utf8;ImagingFourier;DICOMParser;jpeg;metaio;png;pugixml;tiff;RenderingFreeType;freetype;kwiml;CommonDataModel;CommonCore")
